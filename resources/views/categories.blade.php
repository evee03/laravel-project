...
<body>
    ...
    <div class="container">
        ...
        <p class="col-md-6 px-4 text-center mx-auto custom-p pb-2" >Wybierz kategorię, która najlepiej pasuje do treningu, którego szukasz. Po przejściu do kategorii, znajdź odpowiedni trening dla swojego doświadczenia i celów.</p>
